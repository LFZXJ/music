$(function(){
   ...
   var musics=[
     ...
     {name:'Almost Lover',src:'mp3/Almost Lover.mp3',zuoze:'A Fine Frenzy',img:'img/geshou1.png',shichang:'04:30'},
     {name:'丑八怪',src:'mp3/丑八怪.mp3',zuoze:'薛之谦',img:'img/gesho2.png',shichang:'04:13'},
     {name:'好久不见',src:'mp3/好久不见.mp3',zuoze:'陈奕迅',img:'img/geshou3.png',shichang:'04:10'},
     {name:'经过',src:'mp3/经过.mp3',zuoze:'陈楚生',img:'img/geshou4.png',shichang:'04:59'}, {name:'气球',src:'mp3/气球.mp3',zuoze:'许哲佩',img:'img/geshou5.png',shichang:'04:17'},
     {name:'树读',src:'mp3/树读.mp3',zuoze:'王俊凯',img:'img/geshou6.png',shichang:'03:56'},
     {name:'算你狠',src:'mp3/算你狠.mp3',zuoze:'陈小春',img:'img/geshou7.png',shichang:'02:37'},
     {name:'演员',src:'mp3/演员.mp3',zuoze:'薛之谦',img:'img/geshou8.png',shichang:'04:21'},
     {name:'阴天',src:'mp3/阴天.mp3',zuoze:'莫文蔚',img:'img/geshou9.png',shichang:'04:09'},
     {name:'最好的我们',src:'mp3/最好的我们.mp3',zuoze:'王栎鑫',shichang:'03:34'},
   ]
   /*遍历数组 创建一个ul插入页面*/
...
/*获取dom对象的audio*/
  ...
  $(document).on('mouseup',function(){
   ...
   $audio.on('timeupdate',function(){
      ...
      var v=(audio.currentTime/audio.shichang)*$('.gqhc').width();
   ...
   $('.gqhc').on('click',function(e){
      ...
      audio.currentTime=e.offsetX/$('.gqhc').width()*audio.shichang;
   })
   /*当点击小圆点时阻止冒泡事件*/
   ...
   $('.gqhc-yd').on('mousedown',function(e){
      ...
      $(document).on('mousemove',function(e){
        ...
        var v=(e.pageX-left)/width*audio.shichang;
        audio.currentTime=v;
      })
   })
   /*当鼠标抬起时移除拖动的效果*/
...
/*显示时间提示 他的位置跟着鼠标的位置移动  left=鼠标到事件源的位置-自己宽度得到一半*/
      ...
      /*获取播放当前的时长*/
      var w=e.offsetX/$('.gqhc').width()*audio.shichang;
      /*转化为整数*/
       var s=parseInt(w);
